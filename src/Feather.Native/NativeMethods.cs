...
public static class NativeMethods
{
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_context_get_shader_cache_counters(
        FeContextHandle context,
        out FeBackendShaderCacheCounters out_counters);
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics(FeKernelHandle kernel, uint mode);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout(FeKernelHandle kernel, out FeKernelDiagnosticLayout out_layout);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics_v2(
        FeKernelHandle kernel,
        in FeKernelDiagnosticConfigV2 config);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout_v2(
        FeKernelHandle kernel,
        out FeKernelDiagnosticLayoutV2 out_layout);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics_v3(
        FeKernelHandle kernel,
        in FeKernelDiagnosticConfigV3 config);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout_v3(
        FeKernelHandle kernel,
        out FeKernelDiagnosticLayoutV3 out_layout);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics_v4(
        FeKernelHandle kernel,
        in FeKernelDiagnosticConfigV4 config);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout_v4(
        FeKernelHandle kernel,
        out FeKernelDiagnosticLayoutV4 out_layout);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics_v5(
        FeKernelHandle kernel,
        in FeKernelDiagnosticConfigV5 config);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout_v5(
        FeKernelHandle kernel,
        out FeKernelDiagnosticLayoutV5 out_layout);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_configure_diagnostics_v6(
        FeKernelHandle kernel,
        in FeKernelDiagnosticConfigV6 config);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_kernel_get_diagnostic_layout_v6(
        FeKernelHandle kernel,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern FeResult fe_graphics_pipeline_get_vertex_optimization_report(FeGraphicsPipelineHandle pipeline, IntPtr buffer, UIntPtr buffer_size, out UIntPtr out_required_size);
